{
        ...
        },
        {
            ...
            "score": [function(M05_1, M05_2, M05_3, M05_4) {
                ...
                if (M05_1 === 'no' && M05_2 === 'yes' && M05_3 === 'yes' && M05_4 === 'no') {
                    return new Error("Gas Core Sample location")
                }
    ...
    "strings": {
        ...
        "M01-desc": "*Start each Payload clearly rolling down the Space Travel Ramp. For each roll, the cart must * be Independent by the time it reaches the first track connection.",
        ...
        "M02-desc": "Solar Panels need to be Angled toward or away from you.",
        ...
        "M03-desc": "Eject the 2x4 Brick * by placing a Regolith Core Sample into the 3D Printer.",
        ...
        "M04-desc": "The Robot or whatever agent-craft it sends out needs to cross the Craters Model completely, by driving directly over it. Not near it. Not around it.",
        ...
        "M05-desc": "The Robot needs to get all the Core Samples out of the Core Site Model, then it has options for what to do with them as described here, and in Mission M03.",
        ...
        "M05-error": "Gas Core Sample location",
        "M06-name": "M06 Space Station Modules",
        "M06-desc": "The Robot needs to remove and insert Modules among the Habitation Hub’s port holes. Inserted Modules must not be touching anything except the Habitation Hub.",
        ...
        "M07-desc": "The Robot needs to get Gerhard’s body into the Airlock Chamber.",
        ...
        "M08-desc": "The Robot needs to repeatedly move one or both of the Exercise Machine’s Handle Assemblies to make the Pointer advance along its dial. (If the Pointer is partly covering either the gray or orange end borders, select that color.)",
        ...
        "M09-desc": "The Robot needs to lift the Strength Bar to scoring height.",
        ...
        "M10-desc": "Move the Push Bar the right distance at the right speed, to get into the green scoring range.",
        ...
        "M11-desc": "The Robot needs to impact the Strike Pad hard enough to keep the spacecraft from dropping back down.",
        "M11-scoring": "Spacecraft stays up (due only to pressing/hitting the Strike Pad)",
        "M12-name": "M12 Satellite Orbits",
        "M12-desc": "The Robot needs to move one or more Satellites to the Outer Orbit.",
        "M12-scoring": "Satellites on or above the area between the two lines of Outer Orbit:",
        "M13-name": "M13 Observatory",
        "M13-desc": "Rotate the Observatory to a precise direction. (If the Pointer is partly covering either the gray or orange end borders, select that color.)",
        ...
        "penalties-desc": "You’re allowed to hand-rescue your Robot, but that does cause this Penalty",
